...
<head>
    ...
    <style>
        ...
        .gold-gradient { background: linear-gradient(135deg, #D4AF37 0%, #FFD700 50%, #FFEC8B 100%); }
        .gold-text { background: linear-gradient(135deg, #D4AF37 0%, #FFD700 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
        .nav-item.active { background: rgba(212, 175, 55, 0.15); border-bottom: 3px solid #D4AF37; }
        ...
        /* Esta regla hace que aparezca el menú al pasar el mouse */
                ...
                <div class="flex space-x-1">
                    ...
                    <div class="dropdown relative group">
                        ...
                        <div class="dropdown-menu left-0 mt-0 w-48 py-2">
                            <a href="{{ route('reportes.pagos') }}" class="block px-4 py-2 text-gray-200 hover:bg-gray-700 hover:text-white transition text-sm">
                                <i class="fas fa-file-invoice-dollar w-4 mr-2 text-yellow-500"></i> Pagos
                            </a>

                            <a href="{{ route('reportes.pisos') }}" class="block px-4 py-2 text-gray-200 hover:bg-gray-700 hover:text-white transition text-sm">
                                <i class="fas fa-layer-group w-4 mr-2 text-yellow-500"></i> Pisos
                            </a>
                        </div>
                    </div>
